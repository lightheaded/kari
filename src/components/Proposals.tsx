...
export function ProposalPanel({ proposal: p, nodeId, nodeName, account, onClose, onAction, onSelectCard }: Props) {
  ...
  // added, which is the point of the panel: the planner's budget is a default,
  // not a rule the user cannot see past.
        ...
        {accepted ? (
          ...
          <>
            <button
              ...
              onClick={() => onAction(() => api.acceptProposal(nodeId, p.id, picked), "Started")}
            >
